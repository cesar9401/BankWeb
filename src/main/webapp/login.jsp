                ...
                <div class="row align-items-center vh-100">
                    <div class="col-12 col-lg-6 offset-lg-3">
                        <form class="form-signin" action="ManagerController" method="post">
                            ...
                            <input type="number" min="0" id="inputId" class="form-control form-control-lg my-1" name="code" placeholder="Codigo" value="134289" required autofocus>
                            <input type="password" id="inputPassword" class="form-control form-control-lg my-1" name="password" placeholder="Contraseña" value="123$*?=ASkj12" required>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="exampleModalLabel"><span class="badge badge-danger">Error</span></h5>
